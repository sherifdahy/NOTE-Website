...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entities.Models.Document.BaseComponent.BranchAddress", b =>
                {
            ...
            modelBuilder.Entity("Entities.Models.Document.BaseComponent.Buyer", b =>
                {
            ...
            modelBuilder.Entity("Entities.Models.Document.BaseComponent.CommercialDiscountData", b =>
                {
            ...
            modelBuilder.Entity("Entities.Models.Document.BaseComponent.DocumentType", b =>
                {
            ...
            modelBuilder.Entity("Entities.Models.Document.BaseComponent.Header", b =>
                {
            ...
            modelBuilder.Entity("Entities.Models.Document.BaseComponent.Item", b =>
                {
                    b.Property<int>("ItemId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entities.Models.Document.BaseComponent.Seller", b =>
                {
            ...
            modelBuilder.Entity("Entities.Models.Document.BaseComponent.TaxTotal", b =>
                {
            ...
            modelBuilder.Entity("Entities.Models.Document.BaseComponent.TaxableItem", b =>
                {
            ...
            modelBuilder.Entity("Entities.Models.Document.Receipt.Receipt", b =>
                {
                    b.Property<int>("ReceiptId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entities.Models.Document.BaseComponent.CommercialDiscountData", b =>
                {
                    b.HasOne("Entities.Models.Document.BaseComponent.Item", null)
            ...
            modelBuilder.Entity("Entities.Models.Document.BaseComponent.Item", b =>
                {
                    b.HasOne("Entities.Models.Document.Receipt.Receipt", null)
                        .WithMany("ItemData")
            ...
            modelBuilder.Entity("Entities.Models.Document.BaseComponent.Seller", b =>
                {
                    b.HasOne("Entities.Models.Document.BaseComponent.BranchAddress", "BranchAddress")
                        .WithMany()
            ...
            modelBuilder.Entity("Entities.Models.Document.Receipt.Receipt", b =>
                {
                    ...
                    b.HasOne("Entities.Models.Document.BaseComponent.Buyer", "Buyer")
                        .WithMany()
                        .HasForeignKey("BuyerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Entities.Models.Document.BaseComponent.DocumentType", "DocumentType")
                        .WithMany()
                        .HasForeignKey("DocumentTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Entities.Models.Document.BaseComponent.Header", "Header")
                        .WithMany()
                        .HasForeignKey("HeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Entities.Models.Document.BaseComponent.Seller", "Seller")
                        .WithMany()
